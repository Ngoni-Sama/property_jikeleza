...
$return_string.= '
    <div class="featured_property featured_property_type2">';
                ...
                if(  $wpestate_property_unit_slider==1){
                    ...
                    foreach ($post_attachments as $attachment) { 
                        ...
                        $slides     .= '<div class="item">
                                            <a href="'.esc_url($link).'">    <div class="featured_gradient"></div><img  src="'.esc_url($preview_att[0]).'" alt="'.esc_attr($title).'" class="img-responsive" /></a>
                                        </div>';
                    ...
                    <div id="property_unit_featured_carousel_'.intval($prop_id).'" class="carousel slide  " data-ride="carousel" data-interval="false">
                        <div class="carousel-inner">         
                            <div class="item active">    
                                <a href="'.esc_url($link).'">    <div class="featured_gradient"></div><img src="'.esc_url($preview[0]).'" data-original="' . esc_attr($preview[0]) . '" class="lazyload img-responsive" alt="'.esc_html__('image','wpresidence').'"/></a>     
                            </div>
                            '.$slides.'
                        </div>
                    ...
                    $return_string .=  '<a href="'.esc_url($link).'">
                        ...
                        <img src="'.esc_url($preview[0]) . '" data-original="'.esc_attr( $preview[0]).'" class="lazyload img-responsive" alt="'.esc_html__('user image','wpresidence').'"/>
                    </a>
                    ';
                }
            $return_string.= '</div>';
            ...
            $return_string.= '<div class="featured_secondline" >';
            if ($agent_id!=''){
                $return_string.= '
                <div class="agent_face" style="background-image:url('.esc_url($agent_face).')">
